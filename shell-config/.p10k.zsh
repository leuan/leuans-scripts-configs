# Generated by Powerlevel10k configuration wizard on 2023-10-06 at 11:52 EEST.
...
# 12h time, slanted separators, round heads, slanted tails, 2 lines, dotted, no frame,
...
() {
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND=57
  ...
  typeset -g POWERLEVEL9K_DIR_FOREGROUND=105
  ...
  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND=105
  ...
  typeset -g POWERLEVEL9K_VCS_CLEAN_BACKGROUND=99
  typeset -g POWERLEVEL9K_VCS_CLEAN_BRANCHFORMAT_FOREGROUND='white'
  typeset -g POWERLEVEL9K_VCS_CLEAN_BRANCH_FOREGROUND='white'
  typeset -g POWERLEVEL9K_VCS_CLEAN_BRANCHFOREGROUND='white'
  ...
  typeset -g POWERLEVEL9K_STATUS_OK_FOREGROUND=206
  typeset -g POWERLEVEL9K_STATUS_OK_VISUAL_IDENTIFIER_EXPANSION='✔'

  # Status when some part of a pipe command fails but the overall exit status is zero. It may look
  # like this: 1|0.
  typeset -g POWERLEVEL9K_STATUS_OK_PIPE=true
  typeset -g POWERLEVEL9K_STATUS_OK_PIPE_FOREGROUND=206
  ...
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_FOREGROUND=205
  ...
  typeset -g POWERLEVEL9K_BATTERY_{CHARGING,CHARGED}_FOREGROUND=154
  ...
  ####################################[ time: current time ]####################################
  # Current time color.
  typeset -g POWERLEVEL9K_TIME_FOREGROUND=204
